...
public abstract class Combustible extends Vehiculo {
	...
	public Combustible(String matricula,String marca,String modelo,String bastidor,String color,String fecha_adquisicion,Double kms,Categoria categoria,Cliente comprador,int precioalquiler,Oficina oficina) {
